...
# save time by using normalized interface, can update as necessary
...
class bwDB:
    ...
    def insert(self, rec):
        ...
        '''
        klist = sorted(rec.keys()) # grabs all keys of dict object
    ...
    def filename(self, fn):
            self._dbFilename = fn # sets filename
            self._db = sqlite3.connect(fn) # connects to db
            self._db.row_factory = sqlite3.Row # sets up row query
