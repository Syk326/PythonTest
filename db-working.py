...
# libraries in lib folder, he built over the years
...
def listrecs():
    ...
    q = '''
        SELECT * FROM {}
          ...
          LIMIT ?
          OFFSET ?
    '''.format(g['table_name']) # does paging
...
def delete_do():
    ...
    db.delete(id) # calls delete function in db lib
...
def update():
    ...
    db.update(id, rec) # calls update function in db lib
