...
# create module yourself if you want to reuse your code
# add classes thinking about accessibility from outside world
# include main and test functions to try out
# test: %python3 saytime.py test
