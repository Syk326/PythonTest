...
# read errors carefully and with PATIENCE (enough to match the PC!)
# error: "bound method..." -< trying to print method instead of calling (missed parens)
# if nothing happens in file, perhaps start with print in main()

import saytime
import unittest

# Standard Library Unit Test module (automate tests)
...
# special main() that will open and parse and find classes
